...
var setupMigrations = function (client) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, client.query(faunadb_1.query.CreateCollection({ name: "Migration" }))];
            case 2:
                _a.sent();
                return [4 /*yield*/, client.query(faunadb_1.query.CreateIndex({
                        name: "all_migrations",
                        source: faunadb_1.query.Collection("Migration")
                    }))];
            case 3:
                _a.sent();
