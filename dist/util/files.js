            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Promise.all(migrationSubdirs.map(function (migration) { return __awaiter(void 0, void 0, void 0, function () {
                            var migrationFolder, jsResults, fqlResults;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        migrationFolder = migration;
                                        migrationFolder = migration.replace(/:/g, '_');
                                        return [4 /*yield*/, retrieveAllPathsInPattern(path_1.default.join(fullPath, migrationFolder), "**/*.js", ignoreChildDbs)];
                                    case 1:
                                        jsResults = _a.sent();
                                        return [4 /*yield*/, retrieveAllPathsInPattern(path_1.default.join(fullPath, migrationFolder), "**/*.fql", ignoreChildDbs)];
                                    case 2:
                                        fqlResults = _a.sent();
                                        return [2 /*return*/, {
