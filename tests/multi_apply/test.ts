...
import { fullApply, setupFullTest, destroyFullTest, rollback, multiFullApply } from '../_helpers'
...
test('multi apply is the same as separate apply', async (t: ExecutionContext) => {
    ...
    await multiFullApply(testPath, ['resources1', 'resources2', 'resources3', 'resources4'], 4)
